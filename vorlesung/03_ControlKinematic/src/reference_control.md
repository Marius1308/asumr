...
\begin{tikzpicture}
  ...
  \draw[-stealth, red!90!black, line width=1pt] (0,0) -- (4,0);
  % Draw y-axis with stealth arrowhead
  \draw[-stealth,green!60!black, line width=1pt] (0,0) -- (0,4);
  ...
  \draw[-stealth, red!90!black, rotate=30, line width=1pt] (2.5,0.25) -- ++(.4,0);
  \draw[-stealth, green!60!black, rotate=30, line width=1pt] (2.5,0.25) -- ++(0,.4);
  \draw[dashed,-] (2.04, 0) -- (2.04,1.48) node[below left] {$P$};
  \draw[dashed,-] (0, 1.48) -- (3.,1.48);

\draw[-stealth, blue!80!black, rotate=30, line width=1pt] (2.5,0.25) -- ++(1.,0) node[right] {$v$};
\draw[stealth-stealth,line width=1pt, blue!80!black] (2.6, 2.25) arc (60:0:0.8) node[below ] {$\varphi$};
\end{tikzpicture}
\end{document}
```